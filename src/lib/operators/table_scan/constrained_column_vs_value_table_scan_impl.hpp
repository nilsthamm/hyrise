 ...
 */
class ConstrainedColumnVsValueTableScanImpl : public AbstractSingleColumnTableScanImpl {
 public:
  ConstrainedColumnVsValueTableScanImpl(const std::shared_ptr<const Table>& in_table, const ColumnID column_id,
