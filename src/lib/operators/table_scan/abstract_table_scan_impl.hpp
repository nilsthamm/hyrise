...
class AbstractTableScanImpl {
 ...
 protected:
  ...
  static void _scan_with_iterators(const BinaryFunctor func, LeftIterator left_it, const LeftIterator left_end,
    ...
    _scan_with_iterators<CheckForNull, ReturnAfterMatch>(func, left_it, left_end, chunk_id, matches_out, false_type);
  }

  template <bool CheckForNull, bool ReturnAfterMatch, typename BinaryFunctor, typename LeftIterator, typename RightIterator>
